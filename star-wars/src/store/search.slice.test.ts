...
import { searchReducer, setSearchValue, setSearchResult, setIsLoading } from './search.slice';

describe('searchSlice', () => {
  it('should handle setSearchValue action', () => {
    const initialState = { searchValue: '', searchResult: [], isLoading: false };
  ...
  it('should handle setIsLoading action', () => {
    ...
    const nextState = searchReducer(initialState, setIsLoading(true));
